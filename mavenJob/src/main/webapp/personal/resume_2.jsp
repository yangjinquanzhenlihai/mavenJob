...
<script type="text/javascript">
     ...
     function showjob(){
     	$("#sel_category").css("display","inline");
     }    
     function closeJobs(){
     	$("#sel_category").css("display","none");
     }  
      function showtrades(){
     	$("#sel_trade").css("display","inline");
     }    
     function closetrades(){
     	$("#sel_trade").css("display","none");
     }  
     function checkcategorynum(){
     	var len = $("#sel_category input[type='checkbox']:checked").length;
     	if(len>5){
     		alert("最多选5项");
     	}
     ...
     function checktradenum(){
     	var len = $("#sel_trade input[type='checkbox']:checked").length;
     	if(len>5){
     		alert("最多选5项")
     	}
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" >
        <tr>
		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="4" o >
			...
			<tr>
              <td id="td1" height="23" align="right" ><strong  style="color:#FF0000">*</strong>期望工作地区：</td>
              <td>
			  <div class="box1" style="width: 212px">
		...
		<!-- <div id="menu2_s" class="dmenu shadow" style="display:none"></div> -->
			...
			<tr>
              <td id="td2" height="23" align="right"><strong  style="color:#FF0000">*</strong>期望月薪：</td>
              <td>
			  <div class="box2" style="width: 212px">
		...
		<!-- </div> -->
              ...
              <td>
<div>
			  <input type="button" name="Submit22" value="选择 / 修改" onclick="showjob();" class="user_submit"  id="showjobs" />
			   ...
			   <input name="intention_jobs_id" id="intention_jobs_id"  type="hidden" value="" />
			    <div  style="display:none" id="sel_category">
					...
					<div class="OpenFloatBox">
							<div class="title"><h4>请选择职位类别</h4><div class="DialogClose" title="关闭" onclick="closeJobs();" id="closejobs"></div></div>
							...
							<div class="content link_lan">					
										...
										<div class="txt">
										<div align="center"><input type="button"  class="but80 Set" value="确定" onclick="checkcategorynum();"/></div>
										</div>			
							</div>
					</div>
			  </div>
              ...
              <td>	
			   <input type="button" name="Submit23" value="选择 / 修改" class="user_submit"  id="showtrade" onclick="showtrades();"/>
			   ...
			   <input name="trade" id="trade" type="hidden" value="" />
							...
							<div class="OpenFloatBoxBg" ></div>
							<div class="OpenFloatBox">
									<div class="title"><h4>请选择行业</h4><div class="DialogClose" title="关闭" id="closetrade" onclick="closetrades();"></div></div>
									<div class="tip">可多选，最多选择5项</div>
									<div class="content link_lan">					
												<div class="txt">							
																												<div class="item" id="1">
												...
												<div class="txt">
												<div align="center"><input type="button"  class="but80 Set" value="确定" onclick="checktradenum();"/></div>
												</div>			
									</div>
							</div>
					  </div>
